          ...
          root: {
            ...
            '&.featured-card': {
              ...
              '&::after': {
                ...
                width: '30%',
                height: '100%',
                background: palette.redAccent.gradient,
      ...
      MuiButton: {
        styleOverrides: {
          root: {
            ...
            fontWeight: 500,
            textTransform: 'uppercase', // Tipografía expresiva - mayúsculas
            letterSpacing: '0.05em', // Espaciado abierto
            transition: 'all 1.4s cubic-bezier(0.4, 0, 0.2, 1)',
          },
          contained: {
            boxShadow: 'none',
      ...
      MuiAppBar: {
        styleOverrides: {
          root: {
            background:
              mode === 'dark'
                ? `linear-gradient(135deg, #121212 0%, #121212 80%, ${palette.primary.main} 100%)`
                : `linear-gradient(135deg, ${palette.secondary.dark} 0%, ${palette.secondary.dark} 80%, ${palette.primary.main} 100%)`,
            boxShadow: 'none',
          ...
          root: {
            '&.section-title': {
              ...
              '&:after': {
                ...
                width: '3rem',
                height: '2px',
                background: palette.redAccent.bar, // Uso del acento rojo de Toyota
                transition: 'all 1.4s cubic-bezier(0.4, 0, 0.2, 1)',
              },
            },
            '&.toyota-highlight': {
