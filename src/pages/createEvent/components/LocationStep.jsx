      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <FormControl fullWidth margin="normal">
            ...
            <Select
              labelId="location-icono-label"
              id="location.iconoId"
              name="location.iconoId"
              value={formik.values.location.iconoId || ''}
              onChange={formik.handleChange}
              disabled={isLoading}
              error={formik.touched.location?.iconoId && Boolean(formik.errors.location?.iconoId)}
            >
            ...
            {formik.touched.location?.iconoId && formik.errors.location?.iconoId && (
              <FormHelperText error>
                {formik.errors.location.iconoId}
              </FormHelperText>
            )}
        ...
        <Box key={direction.id} sx={{ mb: 2, p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 1 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControl fullWidth margin="normal">
                <InputLabel 
                  id={`location-directions-${index}-icono-label`}
                  sx={{
                    bgcolor: 'background.paper',
                    paddingX: '4px',
                  }}
        ...
        <Box key={parking.id} sx={{ mb: 2, p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 1 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControl fullWidth margin="normal">
                <InputLabel 
                  id={`location-parkings-${index}-icono-label`}
                  sx={{
                    bgcolor: 'background.paper',
                    paddingX: '4px',
                  }}
        ...
        <Box key={point.id} sx={{ mb: 2, p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 1 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControl fullWidth margin="normal">
                <InputLabel 
                  id={`location-interest-points-${index}-icono-label`}
                  sx={{
                    bgcolor: 'background.paper',
                    paddingX: '4px',
                  }}
                ...
                <Select
                  labelId={`location-interest-points-${index}-icono-label`}
